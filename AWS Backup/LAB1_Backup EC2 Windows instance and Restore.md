...
> Vault > Select the Created vault > We can see EC2 instance Id there > Actions > Restore > Now another Instance is created with same name but with different IP > Now we can see the same content with this IP also
