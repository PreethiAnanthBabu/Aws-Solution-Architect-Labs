AWS Console > EC2 > Launch Instance > Give Name , keypair, select AMI and network settings (add rdp and http port from anywhere) > Launch Instance > select the created instance 
